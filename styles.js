...
:root{
  ...
  --surface:#f7f9fc; --surface-elevated:#ffffff;
  --muted:#6b7280; --muted-foreground:#6b7280;
  --border:#e5e7eb;
  --primary:var(--pb-600); --primary-contrast:#ffffff;
...
@media (prefers-color-scheme: dark){
  :root{
    --background:#0b0f14; --foreground:#e6e6e6;
    --surface:#0f141a; --surface-elevated:#11161c;
    --muted:#9aa0a6; --muted-foreground:#9aa0a6;
    --border:#2a2f36;
    --primary:var(--pb-500); --primary-contrast:#ffffff;
...
html[data-theme="light"]{
  ...
  --surface:#f7f9fc; --surface-elevated:#ffffff;
  --muted:#6b7280; --muted-foreground:#6b7280;
  --border:#e5e7eb; --primary:var(--pb-600); --primary-contrast:#fff;
}
html[data-theme="dark"]{
  --background:#0b0f14; --foreground:#e6e6e6;
  --surface:#0f141a; --surface-elevated:#11161c;
  --muted:#9aa0a6; --muted-foreground:#9aa0a6;
  --border:#2a2f36; --primary:var(--pb-500); --primary-contrast:#fff;
}
...
input,select{
  font:inherit; color:var(--foreground); background:var(--surface-elevated);
